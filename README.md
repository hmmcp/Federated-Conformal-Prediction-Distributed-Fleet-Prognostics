...
* **`Simulation/common.py`** contains the shared simulation code used by the synthetic experiments.

* **`Simulation/run_scenario_a.py`** runs the synthetic experiment for sensitivity to the number of HMM latent states.

* **`Simulation/run_scenario_b.py`** runs the synthetic experiment for violation of the left-to-right transition structure.

* **`Simulation/run_scenario_c.py`** runs the synthetic experiment for violation of the shared-emission assumption.

* **`Simulation/run_scenario_d.py`** runs the synthetic experiment for fleet-level heterogeneity in transition dynamics.
...
The simulation experiments are split across four scenario-specific runners:


* **`Simulation/run_scenario_a.py`**

* **`Simulation/run_scenario_b.py`**

* **`Simulation/run_scenario_c.py`**

* **`Simulation/run_scenario_d.py`**


The shared simulation code is implemented in: **`Simulation/common.py`**
...
In each scenario runner under **`Simulation/run_scenario_*.py`**, by default, the hyperparameter:
